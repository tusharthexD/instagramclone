...
function Profile() {
  ...
  useEffect(() => {
    ...
    axios
      .post("https://instaclonebe-rfqu.onrender.com/api/profile/posts", {
        id: id,
      })
      .then((res) => {
        ...
        <div className="col-12 col-md-8 flex-grow-1 d-flex flex-column align-items-center">
          <div className="profileSec col-12 d-flex align-items-center pb-5 mt-4">
            ...
            <div className="ms-5 col-7">
                ...
                <div className="ms-md-5 mt-2 mt-md-0 d-flex justify-content-between col-9 col-sm-6">
                  {myProfile ? (
                    ...
                    <Button
                      style={{ textTransform: "none" }}
                      onClick={followUser}
                      className="py-1 rounded-3 text-white bg-primary"
                    >
              ...
              {/* <Zoom in={uploadStory} > */}
              {story ? (
                <div className="position-absolute top-50 start-50 translate-middle bg light w-100">
                  <UploadStory closeStory={uploadStory} />
                </div>
              ) : null}
              {/* </Zoom> */}
          ...
          <div className="col-12 border-top py-3 d-md-none d-flex px-3 justify-content-between">
            ...
            <p>{result.followers ? result.followers.length : 0} followers</p>
            <p>{result.following ? result.following.length : 0} following</p>
          </div>
